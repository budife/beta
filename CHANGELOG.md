...
- Narrowed the Recent Activity column and upgraded the folder hover into a detailed campaign list panel showing ID, date, campaign name, and manager for every matching folder entry.
