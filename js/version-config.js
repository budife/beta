...
function getCreatorFooterMarkup() {
  ...
  return `© 2025 ${versionInfo.appName} by <a href="https://www.linkedin.com/in/budife/" target="_blank" rel="noopener noreferrer" data-tooltip="Meet the Maker" aria-label="Meet the Maker">budife.psd</a>`;
}
