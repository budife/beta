...
- **Layout Checker v1.5.1 - 24 August 2026** - Added Subject field with KRHRED placeholder support, removed unused Add Unit button, normalized button widths, and improved Highlight KRHRED toggle icon/hover.
