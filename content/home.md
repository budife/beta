...
### 26 August 2026
- **Layout Checker v1.5.3** - Added configurable HTML Fetcher Worker URL setting. Users can set their own Cloudflare Worker domain when the default `*.workers.dev` domain is blocked by corporate networks.
